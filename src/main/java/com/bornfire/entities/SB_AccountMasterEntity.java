...
@Entity
@Table(name = "BLMS_SB_LOAN_MASTER")
public class SB_AccountMasterEntity {
    ...
    public String toString() {
      return "SB_AccountMasterEntity [customer_id=" + customer_id + ", customer_name=" + customer_name
          + ", branch_name=" + branch_name + ", branch_id=" + branch_id + ", loan_type=" + loan_type
          + ", loan_accountno=" + loan_accountno + ", date_of_loan=" + date_of_loan + ", loan_sanctioned="
          + loan_sanctioned + ", margin_limit=" + margin_limit + ", drawing_limit=" + drawing_limit + ", loan_currency="
          + loan_currency + ", disbursement=" + disbursement + ", loan_outstanding=" + loan_outstanding
          + ", loan_period=" + loan_period + ", expiry_date=" + expiry_date + ", repayment_terms=" + repayment_terms
          + ", recovery_method=" + recovery_method + ", del_flg=" + del_flg + ", entity_flg=" + entity_flg
          + ", modify_flg=" + modify_flg + ", effective_interest_rate=" + effective_interest_rate + ", entry_user="
          + entry_user + ", entry_time=" + entry_time + ", modify_user=" + modify_user + ", modify_time=" + modify_time
          + ", verify_user=" + verify_user + ", verify_time=" + verify_time + ", gl_code=" + gl_code + ", gl_desc="
          + gl_desc + ", glsh_code=" + glsh_code + ", glsh_desc=" + glsh_desc + ", scheme_type=" + scheme_type
          + ", scheme_code=" + scheme_code + "]";
    }
    public SB_AccountMasterEntity(String customer_id, String customer_name, String branch_name, String branch_id,
        String loan_type, String loan_accountno, Date date_of_loan, BigDecimal loan_sanctioned, BigDecimal margin_limit,
        BigDecimal drawing_limit, String loan_currency, BigDecimal disbursement, BigDecimal loan_outstanding,
        BigDecimal loan_period, Date expiry_date, String repayment_terms, String recovery_method, String del_flg,
        String entity_flg, String modify_flg, BigDecimal effective_interest_rate, String entry_user, Date entry_time,
        String modify_user, Date modify_time, String verify_user, Date verify_time, String gl_code, String gl_desc,
        String glsh_code, String glsh_desc, String scheme_type, String scheme_code) {
      this.customer_id = customer_id;
      this.customer_name = customer_name;
      this.branch_name = branch_name;
      this.branch_id = branch_id;
