...
public class BLMS_VEHICLE_DET_ENTITY {
	...
	public BLMS_VEHICLE_DET_ENTITY(String name, Date date_of_birth, String phone_number, String email_id,
			String home_address, String marital_status, String place_of_work, String job_title, String work_address,
			String service, String monthly_income, String annual_income, String employer, String employment_nature,
			String vehicle_type, String vehicle_value, String vehicle_model, String registration_number,
			String dealer_name, String dealer_address, String entity_user, String modify_user, String verify_user,
			Date entity_time, Date modify_time, Date verify_time, String entity_flg, String modify_flg,
			String verify_flg, String del_flg, String id) {
		super();
		this.name = name;
		this.date_of_birth = date_of_birth;
		this.phone_number = phone_number;
