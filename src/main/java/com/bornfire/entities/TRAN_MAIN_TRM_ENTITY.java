...
@Entity
@Table(name = "BGLS_TRM_TRANSACTIONS")
public class TRAN_MAIN_TRM_ENTITY {
	@Id
	...
	public TRAN_MAIN_TRM_ENTITY(String srl_no, String branch_id, String acid, String cust_id, String tran_id,
