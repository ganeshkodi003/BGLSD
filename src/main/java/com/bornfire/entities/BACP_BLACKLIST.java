...
@Entity
@Table(name ="BACP_BLACKLIST")

public class BACP_BLACKLIST implements Serializable{
	...
	public BACP_BLACKLIST(String first_name, String shrt_name, String last_name, String nationality, String passport,
			String mbl_num, Date dob, String national_id, String mid_name, String institution, Date date_of_list,
			String remark, String certificate_incorporation, String corporateName, String landlineNo,
