...
public class Principle_and_intrest_shedule_Entity {
	...
	public Principle_and_intrest_shedule_Entity(String loan_account_no, BigDecimal loan_amt,
			...
			String verify_flg, String entity_flg, String modify_flg, String del_flg, String acct_name, Date ver_tm,
			Date entry_tm, Date mod_tm, String ver_usr, String entry_usr, String mod_usr, String installment_id,
			BigDecimal total_installment, Date from_date, String paid_amount) {
		super();
		this.loan_account_no = loan_account_no;
		this.loan_amt = loan_amt;
		this.no_of_instalment = no_of_instalment;
