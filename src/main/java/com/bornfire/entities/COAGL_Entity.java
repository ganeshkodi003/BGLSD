...
@Entity
@Table(name="BGLS_COAGL")
public class COAGL_Entity {
	...
	public COAGL_Entity(String classification, String acct_type, String gl_code, String gl_desc, String glsh_code,
